  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        {isLoading ? (
          <div className="py-20 text-center text-xs text-slate-400">Đang tải thông báo...</div>
        ) : isError ? (
          <div className="py-20 text-center text-xs text-rose-500">Lỗi kết nối API thông báo.</div>
        ) : notifications && notifications.length > 0 ? (
          notifications.map((n: any) => (
            <Card key={n.id} className={n.isRead ? 'opacity-70' : 'border-emerald-500/40'}>
